...
1. 자원봉사 메달로 **보호소 입양 패스**를 제작하여 획득 (펫 보호소 자원봉사 AFK 활동에서 획득 가능)
2. **네온 발자국 보호소** (펫샵 NPC) 방문
...
- **청결**: **털 청결제 스프레이**로 청소
- **행복도**: **나노니블 공**으로 놀아주기
- **체력**: 아플 때 **Paw펙트큐어**로 치료

펫이 돌봄이 필요할 때 배고픔, 더러움, 불행, 아픔 등의 상태 표시가 나타납니다. 잘 관리된 펫 (모든 스탯이 건강함)은 천천히 체력이 회복됩니다.

> **팁:** 펫을 건강하게 유지하려면 매일 확인하세요. 모든 펫 케어 용품은 네온 발자국 보호소에서 구매할 수 있습니다.
