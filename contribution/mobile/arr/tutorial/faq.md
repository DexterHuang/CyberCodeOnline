### Wha' be this game, 'n wha' do I do?
...
**Ye'll receive BTC 'n EXP inside a battle, but items won't drop aft every single battle.**

### Be 'tis game P2W (Pay-t'-Win)?
No. Thar be no element in this game that would benefit or offer additional advantages t' some players o'er others.

Th' Transmitters sold in th' Arasaka Unit Exchange 'ave a global effect, which means once activated, all players on th' server benefit from th' effect. Similarly, purchasable Global Skips apply t' all players who 'ave started AFK tasks.

Th' developer plans t' keep th' game non-P2W in th' future.

### How me can help out?
All user-contributed content be found on th' [Github](https://github.com/DexterHuang/CyberCodeOnline).  
...
Th' developer (DexterHuang) also 'as a [Patreon](https://www.patreon.com/cybercodeonline) fer donations that shall help support 'n maintain th' game.

Thar social links can also be found by accessin' ☰ 'n jabbin' on th' chain link symbol on mobile or by accessin' th' respective platform icons on th' left side o' th' web view.
...
Be warned: th' translations might contain mistakes, be incomplete, or some parts o' th' game might be completely untranslated.
...
Elite Tier 'n higher, will 'ave access t' a bio on thar profile 'n a barcode. 

These benefits be purely cosmetic.
...
They'll show up even if they be nah online 'n they'll receive a notification.

### Does th' chat support emojis 'n kaomojis?
Aye 🤠 ฅ^•ﻌ•^ฅ.

Best not t' overuse or spam these, as such practice be against th' Chat Rules.
...
When yer character reaches level 5, th' crewmate market will unlock.  
...
Only healin' items, ammo, materials, Hash Processors, AI Cores 'n other types o' items can be gifted t' other crewmates.

### Wha' shall I do if me in'entory be full?
Ye can either scrap, destroy or store items in th' bank located in th' City Center. Note that th' fee fer each item ye deposit in th' bank be 100 BTC. Takin' th' item back out be free o' charge.

Ye can also temporarily increase yer booty capacity wit' th' 'Pocket' stat found on equipment 'n upgrade modules.

### How me craft items?
At th' top o' th' Loot page, ye'll find a tab called 'Craftin''

### Where can I get healin' items?
...
Ye can also buy 'em from th' Crewmate Market.

### How do I use me healin' items?
T' equip 'n use yer healin' items, go t' yer loot 'n under yer equipment ye'll find 3 'Quick Slots'.  
Jab on one o' 'em 'n assign yer desired healin' item t' it.  

Ye can use healin' items only inside dungeons.  

### Why can nah I use me Special 'n Destructi'e weapons?
These weapons require ammo. Special weapons use Energy Cells 'n Destructi'e weapons use Anti-Matter Charges.  
Ye can loot ammo from enemies, craft it in yer Loot, or buy it on th' player market.
...
Calibration 'as a chance o' destruction, so be on th' lookout fer Calibration buffs which lower th' destruction chance.
...
1. Print caches at th' 3D Printin' Module. Each cache ye print gives ye printin' exp. Trash caches are th' cheapest t' print 'n th' printed gear can be scrapped fer Tech Scrap.
...
It don't matter if ye print yer caches now or later, but 'tis recommended t' keep yer Legendary caches fer levels 30-40. If ye happen t' find an Epic cache, hold onto it 'til level 100.

Legendary 'n Epic caches be much more expensive t' craft than Rare ones, but th' items 'ave much better stats. Higher quality items can last ye fer a long time, 'n be often worth calibratin' at th' Calibration Station.

### Will higher level enemies give more rewards, matey?
...
Tech scrap costs fer openin' th' containers be 32 Tech Scrap fer common containers, 64 fer rare containers, 'n 128 fer legendary ones.
...
BitCoin be obtained when defeatin' enemies, sellin' items in th' Crewmate Market, 'n by minin' wit' Hash Processors. Hash Processors be found in dungeons 'n may be used t' mine BitCoin at th' [Job Hub].
...
Ye can give 1 Street Cred per day. T' give Street Cred, go t' th' matey's profile, scroll down t' 'Player Actions' 'n jab on [GIVE STREET CRED] located under [ADD T' CREWMATE LIST].
...
Gan' be akin t' guilds or clans in other MMORPGs. Joinin' a gan' gives ye access t' new AFK tasks, a recycler t' make tech scrap, 'n gang chat! Ye also gain access t' gang dungeons, which 'ave a high level o' difficulty but greater rewards than th' regular dungeons.
...
It be forbidden t' 'ave th' same tag as other gan's.
...
- "?" be a quest. Ye can access accepted quests in yer Quest tab.
- "!" be lore.
- Crates be represented by wee white boxes.  
- Crates that 'ave a " " inside 'em hold key fragments.
- Th' yellow ✧ holds a locked container.
- Th' alien lookin' icons show monsters inside th' dungeon.

### Wha' are Public 'n Private Dungeons? Wha' are Password Protected Dungeons?
When creatin' a dungeon, 'twill default t' Public. That means anyone can see 'n join yer dungeon as long as they meet th' level requirements. If ye make yer dungeon Private, 'twill be invisible 'n inaccessible t' other crewmates.

Ye may also create a password fer yer dungeon so that 'tis only accessible by users who know th' password.

### Crewmate are lootin' me stuff. Help!
Th' loot in th' crates be randomly generated fer each crewmate. So, 'tis impossible fer someone t' pillage yer loot.

### Wha' are Tech Scraps?
Tech Scraps be resources obtained from scrappin' caches 'n printed gear. Ye can also generate 'em wit' th' Gan' Recycler.

Ye can use 'em t' level up Printin' Rank faster, craft AI Cores 'n Hash Processors, 'n open Locked Containers.

Th' best way t' get Tech Scrap be t' mass print Trash Caches or Common Caches 'n then mass scrap th' obtained gear.

### Wha' are AI Cores?
AI Cores be items required t' AFK farm dungeons. AFK farmin' provides EXP, items, 'n a wee amount o' BTC. Ye can acquire AI Cores as drops or craft 'em from Hash Processors.

### Wha' are Hash Processors?
Hash Processors ('hash' fer short) be items required t' activate an AFK job that yields high amounts o' BTC (BitCoin). They drop from normal 'n challenge dungeons.

### Wha' are Gan' Memory Shards?
Upon decipherin' 'em, these items give ye a random cache, along wit' minin' 'n gang experience.

### Wha' are Gan' Invasion Orderr Transmitters?
Gang invasion transmitters be special items that drop from th' boss in challenge dungeons.
They be required t' open a Gang Dungeon.

### Wha' are Transmitters?
These be special items that can be bought wit' Units (premium currency) 'n provide global benefits t' all players on th' server. Thar effects range from reducin' th' time on AFK job or activities t' increasin' BTC or EXP gain. These be untradeable.

Thar be also normal transmitters that drop from dungeons, but be less effective than th' paid version.

### Wha' are Equipment Calibration Cores?
Equipment Calibration Cores be used at th' Calibration Station t' upgrade yer gear.

### Wha' are Calibration AI Shards?
These items give a stackable buff that increases th' chance o' success when calibratin'.
...
### Wha's minin' 'n how do I increase me minin' skill?
...
Pockets increase yer loot size. 1 pocket be 1 additional in'entory slot.

### Wha' is th' Bargain Stat?
Bargain gives ye better deals at th' Weapon Smith 'n Trinoky Mart, which be found in th' Central Hub. Ye can both sell 'n buy yer items fer better prices.
