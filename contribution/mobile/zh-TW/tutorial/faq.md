...
**等級 7 後**，你便可以開始製作和裝備和你玩家等級相同裝備，之後你便可以進入 **普通地下城**，或在 **地圖** > **電話圖示** > **地下城列表** 中參加其他玩家的地下城。完成下城可以獲得比打敗附近敵人更多的經驗值。

而最快和最好的升級方法是在啟用 **額葉皮質優化器**（經驗值加成道具）並同時進入 **挑戰地下城** 或 **公會地下城**。

注意：你亦可以透過使用 **AI 核心** 進行 AFK 任務（ **部署掛機機器人**）來提升等級。這個任務最長需要 2 小時來完成。若要獲得更好的效率，你可以選擇在全域時光飛逝期間進行。你可以在　[全域時光飛逝](https://cybercodeonline.com/markdown?path=tutorial%2Fglobal_skip.md)　中找到更多相關資訊。
...
### 什麼是裝備評級？
**裝備評級** 是你穿戴裝備的平均水平。通過計算你所裝備的 5 種武器及防具的平均級別來計算的。包括：主武器或特殊武器（只會計算最高等級的 1 個）以及 4 種非武器／防具（頭盔，上身裝甲，下身裝甲及靴子）。
...
- 如果你的裝備評級比下城的等級高 10 級以上，你將不能在地下城中的箱子中獲取戰利品或從敵人獲得經驗值。
...
### 什麼是 MEGA彈珠盤遊戲？
**MEGA彈珠盤遊戲** 或 **MEGA PACHINKO'S PLUS PRO MAX** 是一項模擬在現實世界中稱為柏青哥（取日語「PACHINKO」音譯）的 AFK 任務。玩家可以透過使用 BTC 來獲得一個非常、非常小的機會來獲得高稀有度物品（例如，你便有可能在彈珠盤遊戲中取得 **史詩裝備** ），雖然，你更有可能獲得的是低稀有度物品（如 **止痛藥**，**能量電池** 或其他物品）。

### 遊戲是否支援玩家之間的交易？
是的，部分支援。你可以將物品發送給其他玩家，但系統並不強制對方提供一些東西作為交換。大多數交易都是在雙方互信的情況下進行的。你不能將比特幣和密鑰碎片發送給其他玩家。僅能發送治療物品、彈藥、材料、雜凑處理器、AI 核心和其他類型的物品。
...
### 如何修復裝備的耐久度？
在當前更新中，耐久度將只是您裝備數據中的一個數字。它永遠不會減少，並且 **修復** 裝備的耐久度的功能亦不再存在。

### 快取記憶體是否與我的等級成正比？我應該把它們保留到以後再使用嗎？
你列印的快取記憶體隨你的列印等級而變化。你從它們那裡獲得的裝備將始終與你的列印等級相同。建議將你的列印等級提升到你當前的玩家級別，以便從列印中獲得最好的裝備。
...
### 如何邀請某人進入我的地下城？
您可以通過點擊 **發送邀請到聊天室** 按鈕邀請任何人進入您的地下城（請記住，邀請是全球發送的）。
