...
- **サブスクリプションプランとプロフィール画像**（該当者のみ）：サブスクリプションに加入して寄付を行っているプレイヤーにのみ解放される機能です. 現在の加入プラン名やプロフィール画像が表示されます. プロフィール画像の編集機能が解放されている場合, 自分のプロフィール画面から画像をクリックすることで画像の変更が行えます.
...
- [ギャングに招待する] - あなたがギャングのリーダー, もしくは権限がある役職の場合のみ, そのプレイヤーをあなたの所属するギャングに招待します.
...
### プレイヤーレベル
これはあなたの基本となるレベルです. 他のスキルはこの数値以上に成長できません. ダンジョンに潜ったり, 敵と戦ったり, 特定のアイテムを使うことで上げられます. 

### クラフトスキル
クラフトスキルは, 分子合成式3Dプリンタで作成するアイテムのレベルに影響します. 　
...
### 収集スキル
収集スキルを上げるためには, まず最下層のエリア（Flori駅のGRECIAN SYNAGOGUE）から収集を始める必要があります. 収集スキルが上がると, より高レベルエリアでも収集が可能になります. ダンジョンなどが表示されている画面の一番下に収集の項目があります.
