 ...
 * Tips.txt
 * Tutorial folder <-- new files need content

For those new to Git please see the tutorial series by Digital Ocean: [An Introduction to Open Source](https://www.digitalocean.com/community/tutorial_series/an-introduction-to-open-source) as well as the [Atom](https://atom.io/) code editor where you can press CTRL+Shift+M to view code changes live inside the application.
 ...
 * Added bitcon display on area page on in mobile
