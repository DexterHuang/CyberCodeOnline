...
- Added some preventive mesure to reduce the chance of unwanted deploying of global buff when another player has alraedy deployed one:
  - When deploying a buff with an active buff and the buff is has more then 19 minutes remaining, the deployment will fail forcefully, you may deploy again after 1 minute if thats what you wish
...
### 2022/07/23 v0.780
- UI - Fixed when traveling to different area, the UI does not scoll to the top
...
### 2022/07/06 v0.780
- NEW - Added new quests for newbies
- UPDATE - Reduced chat quest required amount
...
- Previous `Rare Locked Container` drop rate is reverted and readjusted in later patch after more research.
- UI - Higher level enemy now will show red skull icon in the combat UI next to the enemy name
